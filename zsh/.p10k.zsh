# Generated by Powerlevel10k configuration wizard on 2024-02-26 at 11:16 CET.
...
() {
  ...
  # Branch icon. Set this parameter to '\UE0A0 ' fmarioortizmanero/adoc-pdf-live.nvimor the popular Powerline branch icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_BACKGROUND=32
 ...
 typeset -g POWERLEVEL9K_RBENV_PROMPT_ALWAYS_SHOW=false
  ...
  function prompt_example() {
    p10k segment -b 1 -f 3 -i '⭐' -t 'coffee'
  }
